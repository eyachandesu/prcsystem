...
<body class="bg-slate-100 min-h-screen flex flex-col items-center justify-center font-sans p-4">
  ...
  <div class="mb-6 text-center">
    <!-- Path to logo (assuming it is in the root) -->
    <img src="prclogo.png" alt="PRC Logo" class="h-20 w-20 mx-auto mb-3 drop-shadow-sm">
    ...
    <div class="p-8">
      ...
      <div class="mt-8">
        <div class="flex items-center mb-6">
          ...
          <span class="px-3 text-[10px] text-slate-400 font-bold uppercase tracking-widest">New?</span>
          <div class="flex-grow h-px bg-slate-200"></div>
        </div>
